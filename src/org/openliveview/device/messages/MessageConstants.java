...
/**
 * Message constants reverse-engineered by Andrew de Quincey
 */
public final class MessageConstants {
    ...
    public static final byte DEVICESTATUS_OFF = 0;
    public static final byte DEVICESTATUS_ON = 1;
    public static final byte DEVICESTATUS_MENU = 2;
